...
interface ExpressJsIconProps extends SVGProps<SVGSVGElement>{
  inTag?:boolean;
}

export const ExpressJsIcon = ({ inTag, ...props }: ExpressJsIconProps) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1em" height="1em" {...props}>
      <path 
      fill={ inTag ? theme === 'light' ? '#fff' : '#000' : fillColor} 
